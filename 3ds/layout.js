...
function is_login() {
  if (
    is_login_account("twitter") ||
    is_login_account("facebook") ||
    is_login_account("tumblr")
  ) {
    return true;
  }
  return false;
...
function post_button_text() {
  ...
  if (button_text.length == 0) {
    ...
    $(".area-submit").find(".sns-name").prepend(button_text);
...
function set_share_buttons() {
  ...
  var twitter_button =
    ...
    "&text=" +
    share_text +
    '" class="twitter-share-button" data-width="10px" target="_blank"><img src="img/tweet.png" width="56px" alt="Tweet"/></a>';
  var facebook_button =
    '<a href="http://www.facebook.com/plugins/like.php?href=' +
    share_url +
    '&send=false&layout=standard&width=450&show_faces=false&font&colorscheme=light&action=like&height=35&appId=294416857326059" target="_blank"><img src="img/btn_like.png" width="51px" alt="share"/></a>';
  var tumblr_button =
    '<a href="http://www.tumblr.com/share/link?url=' +
    share_url +
    "&name=" +
    share_text +
    '&title=Share on Tumblr" style="display:inline-block; text-indent:-9999px; overflow:hidden; width:81px; height:20px; background:url(\'img/tumblr-share.png\') top left no-repeat transparent;">Share on Tumblr</a><script src="js/tumblr-share.js"></script>';

  $(".page-footer")
    .find(".share-button")
    .append('<div class="box" id="twitter">' + twitter_button + "</div>");
  $(".page-footer")
    .find(".share-button")
    .append('<div class="box" id="facebook">' + facebook_button + "</div>");
}
...
var b = Date.UTC(2022, 10 - 1, 19, 0, 0, 0);
