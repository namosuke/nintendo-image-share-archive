...
function set_share_buttons() {
  ...
  var twitter_button =
    ...
    "&text=" +
    share_text +
    '" class="twitter-share-button" target="_blank"><img src="img/tweet.png"  alt="Tweet"/></a>';
  var facebook_button =
    '<a href="http://www.facebook.com/plugins/like.php?href=' +
    share_url +
    '&send=false&layout=standard&show_faces=false&font&colorscheme=light&action=like&height=35&appId=294416857326059" target="_blank"><img src="img/btn_like.png"  alt="share"/></a>';
  var tumblr_button =
    '<a href="http://www.tumblr.com/share/link?url=' +
    share_url +
    "&name=" +
    share_text +
    '&title=Share on Tumblr" style="display:inline-block; text-indent:-9999px; overflow:hidden; width:100%; height:100%; margin-left:10px; background:url(\'img/tumblr-share.png\') top left no-repeat transparent;">Share on Tumblr</a><script src="js/tumblr-share.js"></script>';
